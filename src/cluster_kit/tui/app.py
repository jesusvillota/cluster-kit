...
class ClusterTUI(ClusterTUIBase):
    CSS = MAIN_CSS
    BINDINGS = [
        Binding("q", "quit", "Quit"),
        ...
        Binding("e", "toggle_stderr", "Toggle .err", show=False),
        Binding("s", "sync_code", "Sync Code", show=False),
        Binding("j", "job_logs", "Job Logs", show=False),
        Binding("y", "copy_log", "Copy", show=False),
    ]
